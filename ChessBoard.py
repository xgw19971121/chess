...
class ReversiBoard(AbstractChessBoard):
    def __init__(self, w, h, nameList):
        super().__init__(w, h, nameList)
        self.board[3,3] = self.piece[1]
        self.board[3,4] = self.piece[2]
        self.board[4,3] = self.piece[2]
        self.board[4,4] = self.piece[1]
        self.num = np.ones(2)*2
        self.nostep = [False, False] 
